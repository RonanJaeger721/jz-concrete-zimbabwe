    ...
    <main>
      <header className="nav">
        <a className="brand" href="#top" aria-label="J Z Concrete home">
          <img src="/jz/logo.jpeg" alt="J Z Concrete" />
      ...
      <section className="statement" id="capability">
      ...
      <section className="process" id="quality">
      ...
      <footer>
        <div className="footer-brand"><img src="/jz/logo.jpeg" alt="" /><h2>J Z CONCRETE</h2><p>Building Zimbabwe’s future with international engineering excellence.</p></div>
